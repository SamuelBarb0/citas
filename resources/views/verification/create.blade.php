...
<div class="min-h-screen bg-gradient-to-br from-cream via-white to-cream py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-black text-brown mb-3">Último paso: Verificación de identidad</h1>
            <p class="text-gray-600 text-lg">Debes confirmar que eres una persona real antes de poder usar Citas Mallorca</p>
        </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100 p-6">
                ...
                <ul class="space-y-2 text-blue-800">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        <span>Haz un <strong>gesto con la mano</strong> (👍 pulgar arriba, ✌️ señal de paz, etc.)</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span>Nuestro equipo revisará tu solicitud en <strong>24-48 horas</strong></span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span>Recibirás el <strong>badge azul de verificación</strong> en tu perfil</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="p-8">
                <form action="{{ route('verification.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-xs text-gray-500 mt-2">La foto de verificación debe ser similar para confirmar tu identidad</p>
                    </div>

                    <!-- Upload de foto -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-3">
                            Foto de verificación <span class="text-red-500">*</span>
                        </label>
                        ...
                        <div class="relative">
                            ...
                            <label for="verification_photo"
                                ...
                                <div id="upload-placeholder" class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-400">JPG, JPEG o PNG (Máx. 5MB)</p>
                                </div>
        ...
        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-4">
            <div class="flex items-start gap-3">
                ...
                <div class="text-sm text-gray-600">
                    <p class="font-semibold text-gray-800 mb-1">Tu privacidad está protegida</p>
                    <p>• Esta foto NO será visible en tu perfil público</p>
                    <p>• Solo nuestro equipo de moderación la verá para validar tu identidad</p>
                    <p>• Eliminamos las cuentas que no completen este proceso</p>
                </div>
            </div>
        </div>
    </div>
