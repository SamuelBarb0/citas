                                                ...
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    @if($user->profile)
                                                        <a href="{{ route('profile.public', $user->id) }}"
                                                           target="_blank"
                                                           class="text-blue-600 hover:text-blue-900 p-1" title="Ver perfil">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    @if($user->profile)
                                                        @if($user->profile->activo)
                                                            <form action="{{ route('admin.users.suspend', $user->id) }}" method="POST">
                                                                ...
                                                                <button type="submit"
                                                                        ...
                                                                        class="text-orange-600 hover:text-orange-900 p-1" title="Suspender">
                                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        @else
                                                            <form action="{{ route('admin.users.activate', $user->id) }}" method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                                        class="text-green-600 hover:text-green-900 p-1" title="Reactivar">
                                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    @if(!$user->is_admin)
                                                        <form action="{{ route('admin.users.delete', $user->id) }}" method="POST">
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                    onclick="return confirm('¿ELIMINAR PERMANENTEMENTE a {{ $user->name }}? Esta accion no se puede deshacer.')"
