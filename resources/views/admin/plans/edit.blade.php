            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-white/80 mt-1">Modifica las características del plan</p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="number" name="boost_mensual" value="{{ old('boost_mensual', $plan->boost_mensual) }}" min="0"
                                       class="w-full px-4 py-3 border rounded-lg">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Fotos Adicionales</label>
                                <input type="number" name="fotos_adicionales" value="{{ old('fotos_adicionales', $plan->fotos_adicionales) }}" min="0"
                                       class="w-full px-4 py-3 border rounded-lg">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="ver_quien_te_gusta" value="1" {{ old('ver_quien_te_gusta', $plan->ver_quien_te_gusta) ? 'checked' : '' }}
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="matches_ilimitados" value="1" {{ old('matches_ilimitados', $plan->matches_ilimitados) ? 'checked' : '' }}
                                       class="w-5 h-5 text-brown rounded">
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="rewind" value="1" {{ old('rewind', $plan->rewind) ? 'checked' : '' }}
                                       class="w-5 h-5 text-brown rounded">
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="sin_anuncios" value="1" {{ old('sin_anuncios', $plan->sin_anuncios) ? 'checked' : '' }}
                                       class="w-5 h-5 text-brown rounded">
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="modo_incognito" value="1" {{ old('modo_incognito', $plan->modo_incognito) ? 'checked' : '' }}
                                       class="w-5 h-5 text-brown rounded">
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
                                ...
                                <input type="checkbox" name="verificacion_prioritaria" value="1" {{ old('verificacion_prioritaria', $plan->verificacion_prioritaria) ? 'checked' : '' }}
                                       class="w-5 h-5 text-brown rounded">
