        ...
        <div class="flex-shrink-0 bg-gradient-to-r from-brown to-brown-dark shadow-lg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-black text-white">💳 Planes de Suscripción</h1>
                        <p class="text-white/90 mt-1 text-lg">Crear, editar o eliminar planes (precios, funciones, duración)</p>
                    </div>
