...
<div class="min-h-screen bg-gradient-to-br from-cream via-white to-cream">
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="sticky bottom-20 z-40 bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg px-3 py-2.5 border border-gray-200">
                <div class="flex gap-2">
                    <!-- Botón de Like -->
                    <form action="{{ route('like.store', $user->id) }}" method="POST" class="flex-1">
                        @csrf
                        <input type="hidden" name="liked_user_id" value="{{ $user->id }}">
                        <button type="submit" class="w-full bg-gradient-to-r from-heart-red to-heart-red-light text-white py-2.5 px-3 rounded-xl hover:shadow-glow transition-all font-bold text-xs whitespace-nowrap flex items-center justify-center gap-1.5 group">
                    ...
                    @if($hasMatch)
                        ...
                        @endphp
                        <a href="{{ route('messages.show', $match->id) }}" class="flex-1 bg-white text-brown border-2 border-brown py-2.5 px-3 rounded-xl hover:bg-brown hover:text-white transition-all font-bold text-xs whitespace-nowrap flex items-center justify-center gap-1.5 group">
                    ...
                    @else
                        <div class="flex-1 bg-gray-100 text-gray-400 py-2.5 px-3 rounded-xl font-bold text-xs whitespace-nowrap flex items-center justify-center gap-1.5 cursor-not-allowed">
